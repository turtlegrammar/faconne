  ![logo](faconne_logo.png)  Logo courtesy of [Clayton Belcher](http://claytonbelcher.com/).  This README is based on demo.clj. Play with it in a REPL!
```clj
(ns demo
...
## Include
  Lein: `[faconne "1.1.0"]`  Import for Clojure:
```clj
(ns demo
  (:require [faconne.core :as f]))
...
### Vector Destructuring [tentative]
